...
#### 8.课程完结
本课程纯属个人学习编写记录，课程侧重编写界面，讲解界面控件的属性用法，功能代码编写一律通过另一个app查找使用，看完本课程，你应该可以画一个有风格的界面出来了，界面一旦设计完，就可以查看相关的功能代码，通过设置控件的事件，在事件里编写要执行的功能，就可以初步完成一个有功能的小软件了，更过界面介绍和功能代码用法，请自行网上查阅或查看官方的教程，本课程只负责带你入坑，快速了解入门。